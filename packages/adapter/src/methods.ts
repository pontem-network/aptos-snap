...
export async function updateMessagesStatus(this: MetamaskFilecoinSnap): Promise<MessageStatus[]> {
  return await sendSnapMethod({method: "fil_updateMessagesStatus"}, this.snapId);
}
